          ...
          <div className="col-sm">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  {' '}
                  Our company is recognized for the quality of its services. It
                  is a daily commitment on the part of our company to ensure the
                  satisfaction of the customers of our customers. The strengths
                  of the network are the people, the equipment and the work
                  processes.
                </p>
                {/* <a href="#" class="btn btn-primary">
                    Go somewhere
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  month! We’ve recognized how hard you’ve been working . It took
                  a lot of effort and time to offre this kind off service ,
                  organize all the activities and do it all on a high-quality
                  level.
                </p>
                {/* <a href="#" class="btn btn-primary">
                    Go somewhere
